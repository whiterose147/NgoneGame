...
public class RedSpawner : MonoBehaviour
{
    ...
    IEnumerator spawnBall()
    {
        ...
        Instantiate(redProjectilePrefab, localTrans.position,
                Quaternion.Euler(localTrans.rotation.x, localTrans.rotation.y, -90))
            .GetComponent<RedProjectile>().SetDirection(localTrans.right);
