...
public class R8ConstButtonG : MonoBehaviour
{
    public Room8KeyCheckerObject condition;
    ...
    {
        if (other.CompareTag("GreenCBall") && localTimer <= 6)
        {
    ...
    private void Update()
    {
        ...
        localTimer = Mathf.Clamp(localTimer, 0, 6);
