...
public class Room8KeyCheckerObject : MonoBehaviour
{
    public List<Room8Component> components;
    public LevelUI postTime;

    public int roomGoal = 6;
    private int counter;
    ...
    public void Trigger(int value)
    {
        ...
        counter += value;
        counter = Mathf.Clamp(counter, 0, 6); // have to clamp it otherwise it will go over threshold
    ...
    {
        foreach (Room8Component item in components)
            item.ActivateAction();
    }
